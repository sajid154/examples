...
class InstagramController extends BaseController
{
    ...
    public function saveInstagramMessage(Request $request)
     {
            // dd($request->all());
            try {
                ...
                $validator = Validator::make($request->all(), [
                    ...
                    'deviceID' => 'required',
                    'instagramDataList'=> 'required|array|min:1'
                ]);
                if($validator->fails()){
                ...
                $instagram_messages = $request->instagramDataList;
                ...
                foreach($instagram_messages as $message){
                    
               
                    $checkSameDbMsg = InstagramSms::where('device_id', $device->id)
              ...
              return $this->sendResponse($instagram_messages, ['Instagram Sms inserted successfully']);
