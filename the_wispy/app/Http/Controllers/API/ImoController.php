...
class ImoController extends BaseController
{
    ...
    public function saveImoMessages(Request $request)
     {
            try {
                ...
                $validator = Validator::make($request->all(), [
                    ...
                    'deviceID' => 'required',
                    'imoDataList'=> 'required|array|min:1'
                ]);
                if($validator->fails()){
                ...
                $imo_messages = $request->imoDataList;
                ...
                foreach($imo_messages as $message){
                    
                
                    // $checkSameDbMsg = ImoSms::where('device_id', $device->id)
              ...
              return $this->sendResponse($imo_messages, ['Imo Sms inserted successfully']);
