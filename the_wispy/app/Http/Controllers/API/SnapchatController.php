...
class SnapchatController extends BaseController
{
    /**
    ...
    public function saveSnapchatMessages(Request $request)
     {
            try {
                ...
                $validator = Validator::make($request->all(), [
                    ...
                    'deviceID' => 'required',
                    'snapchatDataList'=> 'required|array|min:1'
                ]);
                if($validator->fails()){
                ...
                $snapchat_messages = $request->snapchatDataList;
                ...
                foreach($snapchat_messages as $message){
                    
               
                    $checkSameDbMsg = SnapchatSms::where('device_id', $device->id)
              ...
              return $this->sendResponse($snapchat_messages, ['Snapchat Sms inserted successfully']);
