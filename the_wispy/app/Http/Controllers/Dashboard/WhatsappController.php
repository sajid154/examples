...
class WhatsappController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $wSms = WhatsappSms::with('contact')->where('device_id', $device->id)->groupBy('contact_name')->get();
        // dd($wSms);
        return view('user.whatsapp_sms', compact('wSms', 'id', 'device'));
    }
    ...
    public function default(Request $request)
    {
       ...
       $data = WhatsappSms::where('device_id', $device_id)
