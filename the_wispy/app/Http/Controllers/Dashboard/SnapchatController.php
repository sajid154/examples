...
class SnapchatController extends Controller
{
    ...
    public function index($id)
    {
            ...
            $snapSms = SnapchatSms::with('contact')->where('device_id', $device->id)->groupBy('contact_name')->get();
            return view('user.snapchat_sms', compact('snapSms', 'id', 'device'));
    }
    ...
    public function default(Request $request)
    {
       ...
       $data = SnapchatSms::where('device_id', $device_id)
