...
class ViberController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $vSms = ViberSms::with('contact')->where('device_id', $device->id)->groupBy('contact_name')->get();
        return view('user.viber_sms', compact('vSms', 'id', 'device'));
    }
    ...
    public function default(Request $request)
    {
       ...
       $data = ViberSms::where('device_id', $device_id)
