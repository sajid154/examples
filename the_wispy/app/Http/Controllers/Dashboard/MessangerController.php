...
class MessangerController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $fSms = FacebookMessage::with('contact')->where('device_id', $device->id)->groupBy('contact_name')->get();
        return view('user.messanger_sms', compact('fSms', 'id', 'device'));
    }
    ...
    public function default(Request $request)
    {
       ...
       $data = FacebookMessage::where('device_id', $device_id)
