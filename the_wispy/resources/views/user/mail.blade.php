...
@section('content')
				...
				<p>
					...
					<p style="text-align:left">
						...
						<a style="text-align: center; background-color: #ec008c; color: #fff;padding: 10px 30px; border-radius: 10px; display: inline-block; margin-top: 20px;" href="http://bulksender.site/assets/">Download App</a>
					</p>
