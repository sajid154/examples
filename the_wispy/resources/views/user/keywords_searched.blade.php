...
<div class="row bg-title">
  <div class="col-lg-4 col-md-3 col-sm-3 col-xs-12">
    <h4 class="page-title dashboard">Keywords Alert History</h4> 
  </div>
  ...
  <a href="{{ url('keywords-alert/'.$id) }}" class="btn btn-primary float-right" style="margin-bottom: 20px; margin-left:10px;">Back</a>
    <a href="{{ url('keyword-alert-add/'.$id) }}" class="btn btn-primary float-right" style="margin-bottom: 20px;">Add New Keyword</a>
          ...
          <table id="example" class="uk-table uk-table-striped sms-table" style="width:100%">
            ...
            <tbody>
                  ...
                  <tr>
                      ...
                      <td>{{ $keyword->date_time }}</td>
                      <td>
                          <form method="post" action="{{ url('keyword-alert-history/'.$keyword->id) }}">
