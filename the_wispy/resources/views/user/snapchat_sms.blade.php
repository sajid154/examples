...
<div class="row bg-title">
  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    <h4 class="page-title dashboard">Snapchat Messages</h4> 
  </div>
      ...
      <div class="white-box for-all">
           ...
           @if(sizeof($snapSms) > 0) 
              ...
              <ul class="nav nav-tabs">
                  @foreach($snapSms as $index=> $client)
             ...
             @endif              <div class="col-md-{{ (sizeof($snapSms) > 0)?8:12 }} no-padding">
