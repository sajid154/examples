...
<div class="row bg-title">
  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    <h4 class="page-title dashboard">Keywords Alert</h4> 
  </div>
  ...
  @if(session()->get('success'))
    ...
    <a href="{{ url('keyword-alert-history/'.$id) }}" class="btn btn-primary float-right" style="margin-bottom: 20px; margin-right:20px;">Searched Keywords</a>
          ...
          <table id="example" class="uk-table uk-table-striped sms-table" style="width:100%">
            ...
            <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <form method="post" action="{{ url('keyword-alert/'.$keyword->id) }}">
