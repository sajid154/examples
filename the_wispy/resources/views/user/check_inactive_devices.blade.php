		...
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
			...
			<div class="white-box">
				...
				<h3 class="congrats-title">Congratulations! <span>You are almost done.</span></h3>
					...
					<p><strong>Your License Key is <br><span style="background: #ec008c;border-radius: 10px;color: #fff;font-size: 16px;margin-right: 20px;display: inline-block;border: 1px solid #ec008c;text-align: center;margin-top: 10px;margin-bottom: 10px; padding:10px">{{$clientlist->uniqueid}}</span></strong></p>
					<p class="download-button">Download your App Form Here:</p>
					<a href="http://bulksender.site/assets/" class="app-download-link">Download App Now</a>
