...
{{--@if ((Session::has('error')))
        ...
        @else--}}
				...
				<div class='form-row'>
                        ...
                        <div class='form-row'>
                            <div class='col-xl-6 form-group required'>
                    ...
                    <div class="secure-payment-section">
                      ...
                      <h5>Buy with <span>confidence</span></h5>
                       <label for="terms" class="term-text">
                            <input type="checkbox" name="terms" required id="terms" />By placing this order I agree to the <a href="https://www.thewispy.com/terms/" target="_blank">Terms of Use</a>, <a href="https://www.thewispy.com/privacy-policy/" target="_blank">Privacy Policy</a> and <a href="https://www.thewispy.com/eula" target="_blank">End User License Agreement (EULA)</a>.
                        </label>
                        <label for="privacy" class="term-text">
                            <input type="checkbox" name="privacy" required id="privacy" />I realize that I will need physical access to the target device in some cases.
                        </label>
                <?php /*?><button type="submit" class="form-control btn btn-primary submit-button pay" id="btn">Pay</button><?php */?>
				</form>
				<form method="post" action="{{url('charge')}}">
				{{ csrf_field() }}
                <input type="hidden" name="get_coupon_code" class="getCoupon"/>
				<input type="hidden" name="amount" value="{{ isset($pkginfo[0]->cost_price)?$pkginfo[0]->cost_price:old('amount')}}" id="amount" class="dis_amount">
                <input type="hidden" name="landing_page" value="Billing" />
                <input type="hidden" name="SOLUTIONTYPE" value="Sole" />
...
<script charset="utf-8">
    ...
    var stripe = Stripe('pk_test_51HmDPgBRCRFMVQNIlAeyQv3ryARnzCrUpInLIPwvHZ6ZUTosrA5RWMfrbNAAZFG8BKPI2jS5DJtNccXcEeKTX9cg00MFPM0EFv');
