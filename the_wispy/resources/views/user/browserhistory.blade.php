...
<div class="row bg-title">
  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    <h4 class="page-title dashboard">Browser History</h4> 
  </div>
      ...
      <div class="white-box for-all">
        ...
        <div class="container no-padding">
          ...
          <table id="example" class="uk-table uk-table-striped sms-table" style="width:100%">
            <thead class="call-log-heading" style="padding: 50px;">
              <tr>
                <th>Serial No</th>
                <th>Browser Name</th>
                <th>URL</th>
            ...
            <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="{{ $history->url_name }}" target="_blank">{{ $history->url_name }}</a></td>
                      <td>{{ $history->date_time }}</td>
                      <td>
                          <form method="post" action="{{ url('browser-history/'.$history->id) }}">
