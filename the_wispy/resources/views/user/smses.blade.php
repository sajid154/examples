...
<div class="row bg-title">
  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    <h4 class="page-title dashboard">Messages</h4> </div>
      ...
      <div class="white-box for-all">
           ...
           @if(sizeof($clientlists) > 0) 
              ...
              <ul class="nav nav-tabs">
                  ...
                  <li class="{{ $loop->first ? 'active' : '' }} sms-user_list">
                    <a data-toggle="tab" href="{{$client->id}}" id="number_val" class="number_val" value="{{ $client->number }}"><div class="sms_user_icon"><i class="fa fa-user fa-fw" aria-hidden="true"></i></div><div class="sms_user_detail"><strong>{{$client->contact_name}}</strong>
          <p>{{str_limit($client->message, $limit = 30, $end = '...')}}</p></div></a></li>
               ...
               @endif
              <div class="col-md-{{ (sizeof($clientlists) > 0)?8:12 }} no-padding">
    ...
    z-index: 9; bottom:77px' >",
       ...
       "paging": false,
        ...
        columns: [
            ...
            { data: 'date_time_f', name: 'date_time_f'},
            // { data: 'id', name: 'id'},
