      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('superadmin/edit-email-template/'.$templateDetails->id) }}" name="add_coupon" id="add_coupon">{{ csrf_field() }}

              <div class="control-group">
                <label class="control-label">Title</label>
                <div class="controls">
                  <input value="{{ $templateDetails->title }}" type="text" name="title" id="title" maxlength="15" minlength="5" required>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <textarea cols="80" id="editor1" name="content" rows="10" data-sample-short>{{ $templateDetails->content }}
                    </textarea>

<!-- 
                  <input value="{{ $templateDetails->content }}" type="number" name="content" id="content" required> -->
                </div>
              </div>
