      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('superadmin/add-coupon') }}" name="add_coupon" id="add_coupon">{{ csrf_field() }}
              ...
              <div class="control-group col-md-3">
                ...
                <div class="controls">
                  <input type="Date" name="expiry_date" id="expiry_date" required  class="form-control datepicker-autoclose">
                </div>
              </div>
              <div class="control-group">
