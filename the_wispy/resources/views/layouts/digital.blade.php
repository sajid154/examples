            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li style="padding: 60px 0 0;">
                        <a href="{{ url('/marketing') }}" class="waves-effect"><i class="fa fa-mobile fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="{{ route('market-edit') }}" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Account Edit</a>
                    </li>
                  
                    <li>
                        <a href="{{ route('market-agents') }}" class=""><i class="fa fa-users fa-fw" aria-hidden="true"></i>Agents</a>
                    </li>
                    <li>
                        <a href="{{ route('market-messages') }}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Messages</a>
                    </li>
